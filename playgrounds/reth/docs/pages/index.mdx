# Reth Book [Documentation for Reth users and developers]
...
<img src="/reth-alpha.png" style={{ borderRadius: '20px' }} />
...
- Install Reth by following the [guide](./installation/binaries.md).
