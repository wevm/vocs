...
- **Developer experience** Automatic [type safety and inference](/typescript), comprehensive documentation, composable APIs.
...
You can learn more about the rationale behind the project in the [Why Viem](/why-viem) section.
