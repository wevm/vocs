...
// module into `dist`). Can also be run directly: `node scripts/build-openapi-standalone.mjs`.
 ...
 *
 * THIS FILE IS GENERATED by \`scripts/build-openapi-standalone.mjs\` (run as part
