...
Vocs ships instant, client-side [**Keyword Search**](#keyword-search) powered by [MiniSearch](https://lucaong.github.io/minisearch/) — no configuration required. On top of that you can opt into [**AI Search**](#ai-search), which ranks results by *meaning* rather than exact terms, so "how do I ship my site" finds your Deployment guide even when it never uses the word "ship".
