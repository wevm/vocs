...
- [**Keyword Search**](#keyword-search) (enabled by default): instant, client-side full-text search powered by [MiniSearch](https://lucaong.github.io/minisearch/) — no configuration required.
