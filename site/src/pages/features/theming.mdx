...
Put the font files in `public/fonts` or another static asset path. For package-based
font loading with Vite's CSS processing, see [Fonts](/features/fonts).
...
<Cards>
  ...
  <Card
    title="Fonts"
    description="Load custom fonts with Vite and Vocs CSS variables."
    icon="type"
    to="/features/fonts"
  />
</Cards>
