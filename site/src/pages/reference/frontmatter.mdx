...
<Cards>
  <Card
    ...
    description="Tutorial-style guide to authoring frontmatter."
    icon="file-text"
    to="/writing/frontmatter"
  />
  <Card
    title="MDX Wrapper"
    description="Read custom frontmatter inside section wrappers."
    icon="layout-template"
    to="/features/layouts#mdx-wrapper"
  />
  <Card
    title="Site Configuration"
    description="Site-wide options accepted by defineConfig."
    icon="settings"
