...
Use the `:::prompt` directive for instructions that readers can copy into an AI agent. Vocs highlights URLs, inline code, labels, list markers, and placeholders without changing the copied text.
