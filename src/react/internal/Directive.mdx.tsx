import { directives } from 'virtual:vocs/directives'
 ...
 * its directive's component — user directives (`_directives.tsx`) first,
 * then built-ins — passing attributes through as props.
 */
export function Directive(props: Directive.Props): React.JSX.Element | null {
  ...
  const Component =
    directives.find((directive) => directive.name === name && directive.component)?.component ??
    builtins[name]
