...
export function FolderToggle(props: FolderToggle.Props) {
  ...
  return (
    <div className="vocs:flex vocs:flex-col">
      <button
        className="vocs:flex vocs:items-center vocs:gap-2 vocs:not-disabled:cursor-pointer vocs:bg-transparent vocs:border-none vocs:p-0 vocs:m-0 vocs:text-primary vocs:data-[highlighted=true]:bg-surfaceTint vocs:data-[highlighted=true]:border vocs:data-[highlighted=true]:border-primary vocs:rounded-md vocs:px-2 vocs:py-0.5 vocs:-mx-2 vocs:-my-0.5"
